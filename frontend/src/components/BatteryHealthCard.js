...
const BatteryHealthCard = ({ diagnostics }) => {
  ...
  if (!diagnostics?.battery) {
    return (
      <div className="bg-[#121212] border border-white/10 rounded-xl p-6 animate-pulse" data-testid="battery-card-loading">
  ...
  return (
    <div className="bg-[#121212] border border-white/10 rounded-xl p-6 hover:border-[#3E6AE1]/50 transition-all duration-300" data-testid="battery-health-card">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm text-[#A1A1AA] uppercase tracking-wider" data-testid="battery-status">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div data-testid="battery-level">
          <p className="text-sm text-[#A1A1AA] mb-1">Charge Level</p>
          <p className="text-3xl font-bold" style={{ color: batteryColor }}>{level}%</p>
        </div>
        <div data-testid="battery-health">
          <p className="text-sm text-[#A1A1AA] mb-1">Health</p>
          <p className="text-3xl font-bold text-white">{health}%</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
        <div data-testid="battery-voltage">
          ...
          <p className="text-sm font-medium text-white">{voltage}V</p>
        </div>
        <div data-testid="battery-temperature">
          <p className="text-xs text-[#A1A1AA] mb-1">Temperature</p>
